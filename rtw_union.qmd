---
title: "Union density rates in right-to-work (RTW) versus non-RTW states"
...
\[**2/10/26 UPDATE:** See [here](https://economic.github.io/earn_code_library/rtw_definitions.html) for a more accurate way to assign RTW vs non-RTW labels that takes into account changes in status over time. The code below has not been updated to account for this new methodology.\]
