...
```{=html}
<!--
- One of the foundational concepts of `ggplot2` is the layering system. Plots are constructed by "stacking" different layers.
- Various "geoms" (short for "geometric objects") can be added, each representing different types of charts.
-->
```
...
```{=html}
<!--
- Beyond layering geometries, `ggplot2` allows for robust customization of visual properties, enabling intricate and informative visualizations.
- Adjusting properties like color, size, shape, and transparency can enhance plot interpretability and aesthetic.
-->
```
