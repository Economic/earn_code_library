...
```{r, loading missing data, eval=FALSE, include=FALSE, message=FALSE}
library(tidyverse)
library(epiextractr)
...
```{r, example rolling epops,  eval=FALSE, include=FALSE, message=FALSE}
#libraries 
library(tidyverse) 
library(epiextractr) 
library(slider) 
...
```{r, actual 12month rolling,  eval=FALSE, include=FALSE, message=FALSE}
