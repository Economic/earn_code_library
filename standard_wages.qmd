...
Since we'll be working with EPI data extracts, we'll need to make sure we have the `epiextractr` package loaded.

```{r, load libraries, eval=FALSE, include=FALSE, message=FALSE}
library(tidyverse)
library(epiextractr)
```

## Defining the universe for employment or wage analysis
...
```{r, cps download and filter, eval=FALSE, include=FALSE, message=FALSE}
...
```{r, Median wages, eval=FALSE, include=FALSE, message=FALSE}
...
```{r, wage premiums and regressions, eval=FALSE, include=FALSE, message=FALSE}
library(fixest) 
...
```{r, imputed wages, eval=FALSE, include=FALSE, message=FALSE}
mutate(
...
```{r, filter out imputed wages, eval=FALSE, include=FALSE, message=FALSE}
